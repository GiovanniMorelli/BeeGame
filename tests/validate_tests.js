/*describe('bee app module', function() {
    var $scope;
    var controller;
    ...
    describe('Bee controller', function(){

        it('should retrun true if the BeGame Controller was defined', inject(function($controller,_$rootScope_) {
            $scope = _$rootScope_.$new();
            controller = $controller;

            var beeGameCtrl = $controller('beeGameController',{"$scope" : $scope});
            expect(beeGameCtrl).toBeDefined();
        }));
...
*/
/*
describe('Bee Game  controllers', function () {
    beforeEach(module('bee'));
    //beforeEach(module('beeGameController'));

    describe('beeGameController', function () {
        it('should return true if the BeeGame Controller was defined', inject(function ($controller) {
            var $scope = {};
            // this is the line that caused me pain
           var controllerBeeGame =  $controller('beeGameController', { $scope: $scope });
            expect($scope.queen).toBe(100);
        }));
    });
});*/
